...
const experiences = [
  {
    ...
    description: [
      'Building scalable data pipelines and AI-powered solutions for financial services',
      'Developing microservices architecture for high-throughput transaction processing',
  ...
  },
  {
    ...
    location: 'Hyderabad, India',
    description: [
      'Developed and published Flink applications for real-time and batch stream processing',
      'Administered Airflow infrastructure and created workflows for job orchestration',
      'Built applications to ingest and process data from third-party data platforms',
      'Contributed to an internal Python library with generic classes for common tasks',
    ],
    color: 'secondary',
  },
  {
    ...
    description: [
      'Processed 100+ billion records using Spark and managed 200+ HIVE tables',
      'Worked on ETL pipelines using Informatica Mappings for data transformation',
      'Built predictive machine learning models and a real-time Tableau dashboard',
      'Delivered modules for an in-house optimization product across multiple phases',
    ],
    color: 'accent',
  },
];
