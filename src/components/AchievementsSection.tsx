...
const achievements = [
  {
    icon: Award,
    title: 'Phenomenal CRISP Award',
    description: 'Nominated for exceptional performance and contribution at Phenom People',
    color: 'primary',
  },
  {
    icon: Trophy,
    title: 'Medha 2018 Winner',
    description: 'First place in Paper Presentation competition',
    color: 'secondary',
  },
  {
    icon: Medal,
    title: 'NIPUNA 2019 Champion',
    description: 'Winner of Quiz competition demonstrating technical knowledge',
    color: 'accent',
  },
  {
    icon: GraduationCap,
    title: 'B.Tech in Electronics',
    description: 'Graduated from GIET College of Engineering, Rajahmundry',
    color: 'primary',
  },
];
